...
**API mechanics live in `carrier-research/dragonfly/api/` (private research repo)** — the endpoint,
...
**Events**); this file documents integration decisions, `carrier-research/dragonfly/api/` documents the
