"""Tests for the Dragonfly deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.dragonfly.calendar import DragonflyDeliveriesCalendar
...
def _cal(data):
    return DragonflyDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Dragonfly Shop")])
    assert cal._events()[0].location == "Dragonfly Shop"
