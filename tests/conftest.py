"""pytest configuration for the Dragonfly test suite."""
import sys
...
def auto_enable_custom_integrations(enable_custom_integrations):
    """Make ``custom_components.dragonfly`` loadable from config-flow / setup tests."""
    yield
...
def reset_one_shot_warnings():
    ...
    """
    from custom_components.dragonfly import parcels

    parcels._unmapped_steps_logged.clear()
    yield
